...
final class SecureStore {
    ...
    private static final String ALIAS="pmt_sms_bridge_key_v2";
    ...
    private static void putInternal(Context c,String key,String value)throws Exception{
        ...
        c.getSharedPreferences(PREFS,Context.MODE_PRIVATE).edit().putString(key,packed).commit();
    }
    ...
    private static SecretKey getOrCreateKey()throws Exception{
        ...
        KeyGenerator g=KeyGenerator.getInstance("AES",STORE);g.init(128);return g.generateKey();
    }
