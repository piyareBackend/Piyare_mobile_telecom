 ...
 * Code.gs predates the access-control helpers and still calls its legacy
 * login_/users_/createUser_/updateUser_ functions. Rebind those entry points
 * to the corrected access-control implementation without creating another
 * doGet/doPost declaration. This keeps the consolidated router intact.
 */
...
/* Add only the missing access-control actions around the existing router. */
